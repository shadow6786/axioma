               ...
               <div class="fullwidthbanner rslider">
                  <ul>
                     ...
                     <li data-delay="6000" data-masterspeed="300" data-transition="fade">
                        <div class="slotholder"><img src="<?= cdn_base('img/slider/slider-bg-1.jpg'); ?>" data-fullwidthcentering="on" alt="Pixma"></div>
                        ...
                        <div class="caption lfb caption_button_2 fadeout tp-caption start"
                           ...
                           data-hoffset="70"
                           data-easing="easeOutExpo">
                           <a class="btn-special hidden-xs btn-color" href="https://wrapbootstrap.com/theme/pixma-responsive-multipurpose-template-WB0B348C6">Buy Now</a>
                        </div>
                     </li>
                     <!-- THE RESPONSIVE SLIDE -->
                     <li data-transition="fade" data-slotamount="1" data-masterspeed="300">
                        <img src="<?= cdn_base('img/slider/slider-bg-2.jpg'); ?>" data-fullwidthcentering="on" alt="">
                        ...
                        <div class="caption lfl"
                           ...
                           data-start="1400"
                           data-easing="easeOutExpo">
                           <img src="<?= cdn_base('img/slider/responsive-imac.png'); ?>" alt="iMac Responsive">
                        </div>
                        <div class="caption lfl"
                           data-x="323"
                           data-y="145"
                           ...
                           data-start="1500"
                           data-easing="easeOutExpo">
                           <img src="<?= cdn_base('img/slider/responsive-ipad.png'); ?>" alt="iPad Responsive">
                        </div>
                        <div class="caption lfl"
                           data-x="472"
                           data-y="253"
                           ...
                           data-start="1600"
                           data-easing="easeOutExpo">
                           <img src="<?= cdn_base('img/slider/responsive-iphone.png'); ?>" alt="iPhone Responsive">
                        </div>
                     </li>
                  </ul>
               </div>
                              ...
                              <div class="carousel-inner">
                                 <div class="item active">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item animate_afc d2">
                                       <div class="portfolio-item">
                                          <a href="<?= cdn_base('img/portfolio/portfolio-1.jpg'); ?>" class="portfolio-item-link" data-rel="prettyPhoto" >
                                          <span class="portfolio-item-hover"></span>
                                          <span class="fullscreen"><i class="icon-search"></i></span><img src="<?= cdn_base('img/portfolio/portfolio-1.jpg'); ?>" alt=" "/>
                                          </a>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item animate_afc d3">
                                       <div class="portfolio-item">
                                          <a href="<?= cdn_base('img/portfolio/portfolio-2.jpg'); ?>" class="portfolio-item-link" data-rel="prettyPhoto" >
                                          <span class="portfolio-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img src="<?= cdn_base('img/portfolio/portfolio-2.jpg'); ?>" alt=" "/>
                                          </a>
                                          <div class="portfolio-item-title">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item animate_afc d4">
                                       <div class="portfolio-item">
                                          <a href="<?= cdn_base('img/portfolio/portfolio-3.jpg'); ?>" class="portfolio-item-link" data-rel="prettyPhoto" >
                                          <span class="portfolio-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img src="<?= cdn_base('img/portfolio/portfolio-3.jpg'); ?>" alt=" "/>
                                          </a>
                                          <div class="portfolio-item-title">
                                 ...
                                 <div class="item">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item">
                                       <div class="portfolio-item">
                                          <a href="<?= cdn_base('img/portfolio/portfolio-4.jpg'); ?>" class="portfolio-item-link" data-rel="prettyPhoto" >
                                          <span class="portfolio-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img src="<?= cdn_base('img/portfolio/portfolio-4.jpg'); ?>" alt=" "/>
                                          </a>
                                          <div class="portfolio-item-title">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item">
                                       <div class="portfolio-item">
                                          <a href="<?= cdn_base('img/portfolio/portfolio-5.jpg'); ?>" class="portfolio-item-link" data-rel="prettyPhoto" >
                                          <span class="portfolio-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img src="<?= cdn_base('img/portfolio/portfolio-5.jpg'); ?>" alt=" "/>
                                          </a>
                                          <div class="portfolio-item-title">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item">
                                       <div class="portfolio-item">
                                          <a href="<?= cdn_base('images/portfolio/portfolio-6.html'); ?>" class="portfolio-item-link" data-rel="prettyPhoto" >
                                          <span class="portfolio-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img src="<?= cdn_base('img/portfolio/portfolio-6.jpg'); ?>" alt=" "/>
                                          </a>
                                          <div class="portfolio-item-title">
                        ...
                        <ul>
                           <li class="">
                              <div class="blog-showcase-thumb col-lg-4">
                                 <div class="post-body">
                                    <a class="post-item-link" href="<?= cdn_base('img/portfolio/portfolio-5.jpg'); ?>" data-rel="prettyPhoto"><span class="post-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img alt="" src="<?= cdn_base('img/portfolio/portfolio-5.jpg'); ?>"></a>
                                 </div>
                              </div>
                           ...
                           <li>
                              <div class="blog-showcase-thumb col-lg-4">
                                 <div class="post-body">
                                    <a class="post-item-link" href="<?= cdn_base('img/portfolio/portfolio-6.jpg'); ?>" data-rel="prettyPhoto"><span class="post-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img alt="" src="<?= cdn_base('img/portfolio/portfolio-6.jpg'); ?>"></a>
                                 </div>
                              </div>
                              <div class="blog-showcase-extra-info col-lg-4">
                                 <span><a href="#">Sep 11th, 2013</a></span>
                           ...
                           <li class="blog-first-el">
                              <div class="blog-showcase-thumb col-lg-4">
                                 <div class="post-body">
                                    <a class="post-item-link" href="<?= cdn_base('img/portfolio/portfolio-7.jpg'); ?>" data-rel="prettyPhoto"><span class="post-item-hover"></span><span class="fullscreen"><i class="icon-search"></i></span><img alt="" src="<?= cdn_base('img/portfolio/portfolio-7.jpg'); ?>"></a>
                                 </div>
                              </div>
                              <div class="blog-showcase-extra-info col-lg-4">
                                 <span><a href="#">Sep 11th, 2013</a></span>
                                    ...
                                    <div class="carousel-inner">
                                       <div class="item active">
                                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item animate_afc d1">
                                             <div class="item-inner"><a href="#"><img alt="Upportdash" src="<?= cdn_base('img/clientslogo/logo-1.png'); ?>"></a></div>
                                          </div>
                                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item animate_afc d2">
                                             <div class="item-inner"><a href="#"><img alt="Upportdash" src="<?= cdn_base('img/clientslogo/logo-2.png'); ?>"></a></div>
                                          </div>
                                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item animate_afc d3">
                                             <div class="item-inner"><a href="#"><img alt="Upportdash" src="<?= cdn_base('img/clientslogo/logo-3.png'); ?>"></a></div>
                                          </div>
                                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item animate_afc d4">
                                             <div class="item-inner"><a href="#"><img alt="Upportdash" src="<?= cdn_base('img/clientslogo/logo-4.png'); ?>"></a></div>
                                          </div>
                                       </div>
                                       <div class="item">
                                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item">
                                             <div class="item-inner"><a href="#"><img alt="Upportdash" src="<?= cdn_base('img/clientslogo/logo-5.png'); ?>"></a></div>
                                          </div>
                                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 item">
                                             <div class="item-inner"><a href="#"><img alt="Upportdash" src="<?= cdn_base('img/clientslogo/logo-4.png'); ?>"></a></div>
                                          </div>
                                          ...
                                          <div class="item active">
                                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="testimonial item">
                                                   ...
                                                   <div class="author">
                                                      <div class="testimonial-image "><img alt="" src="<?= cdn_base('img/testimonial/team-member-1.jpg'); ?>"></div>
                                          ...
                                          <div class="item">
                                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="testimonial item">
                                                   ...
                                                   <div class="author">
                                                      <div class="testimonial-image "><img alt="" src="<?= cdn_base('img/testimonial/team-member-2.jpg'); ?>"></div>
                                                      <div class="testimonial-author-info">
                                          ...
                                          <div class="item">
                                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="testimonial item">
                                                   ...
                                                   <div class="author">
                                                      <div class="testimonial-image "><img alt="" src="<?= cdn_base('img/testimonial/team-member-3.jpg'); ?>"></div>
                                                      <div class="testimonial-author-info">
